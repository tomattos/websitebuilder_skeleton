...
import * as fromComponentSettingsStore from '../../../component-settings/state/reducers/component-settings.reducer';
import * as fromComponentBuilderStore from '../../../component-builder/state/reducers/component-builder.reducer';
import * as fromPagesStore from '../../../pages/state/reducers/pages.reducer';
